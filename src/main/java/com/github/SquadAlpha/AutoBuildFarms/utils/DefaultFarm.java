...
public class DefaultFarm {
    public static void add(AutoBuildFarms plugin) {
        ...
        f.addSize("small", "&bSmall", "CactusSmall.schematic", 100, new ItemStack(Material.CACTUS, 1), Collections.singletonList(new ItemStack(Material.CACTUS, 1)));
        f.addSize("medium", "&bMedium", "CactusMedium.schematic", 500, new ItemStack(Material.CACTUS, 2), Collections.singletonList(new ItemStack(Material.CACTUS, 25)));
        Config.addFarm(f);
        Config.save();
        Config.reload();
        Config.init();
